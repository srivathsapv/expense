...
<div id = "body-content">
	<form method = "POST" class="validate">
  		<fieldset>
    		...
    		<input class = "span4 required" onkeyup="uppercase(this)" type="text" valtype="required alphanumeric" valmsg="Invalid short name" placeholder="Enter the department shortname..."><br>
