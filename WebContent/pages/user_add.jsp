...
<div id = "body-content">
	<form method = "POST" class = "validate">
  		<fieldset>
    		...
    		<input class = "span4 required" valtype = "required alpha" valmsg="First name should contain only alphabets" type="text" placeholder="First name..."><br/>
    		<input class = "span4" type="text" valtype = "alpha" valmsg="Middle name should contain only alphabets" placeholder="Middle name..."><br>
    		<input class = "span4" type="text" valtype = "alpha" valmsg="Last name should contain only alphabets" placeholder="Last Name..."><br>
    		...
    		<select class = "span4 required" valtype = "required">
   			...
   			<input class = "span4 required" valtype = "required alpha" valmsg="Designation should contain only alphabets" type="text" placeholder="Designation..."><br>
