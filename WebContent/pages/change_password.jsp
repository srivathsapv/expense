...
<div id = "body-content">
	<form method = "POST">
  		<fieldset>
			...
			<input class = "span4" type="password" placeholder="Enter the current password..."> <br>
			<input class = "span4" type="password" placeholder="Enter the new password..."><br>
			<input class = "span4" type="password" placeholder="Confirm password..."><br>
