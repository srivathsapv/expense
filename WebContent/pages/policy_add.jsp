...
<div id = "body-content">
	<form method = "POST" class="validate" action = "../server/policy_add.jsp">
  		<fieldset>
    		...
    		<% } %>
			<input class = "span4 required" type="text" valtype="required SpecialCharacters" valmsg="Title should contain only alphanumeric values" placeholder="Enter the title..." name = "title"> <br>
